...
export default function PricingPage() {
  ...
  // FIX: Type signature of 'value' changed to 'string'
  const handleTabChange = (value: string) => {
    // Assert the type back to the union literal if needed for internal logic
    const tabValue = value as "employers" | "students";
    setActiveTab(tabValue);
    // Push new hash to URL, allowing browser history navigation
    router.push(`/pricing#${tabValue === "employers" ? "employer" : "student"}`);
  };
                                    ...
                                    onClick={() => {
                                        if (user) {
                                            ...
                                            if (user.user_type === 'student') {
                                                ...
                                                router.push('/post-job'); // Employer: Redirect to post a job
                                            }
                                        } else {
