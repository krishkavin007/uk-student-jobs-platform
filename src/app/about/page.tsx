...
export default function AboutPage() {
  ...
  return (
    <motion.div
      className="min-h-screen bg-gray-950 text-zinc-50 font-sans antialiased relative overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0 z-0 opacity-10">
        <div className="w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-800 via-zinc-950 to-zinc-950"></div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="fixed top-0 left-0 right-0 z-50 h-20 bg-gray-900/80 backdrop-blur-md border-b border-zinc-800 shadow-lg flex items-center px-4">
          <div className="animate-pulse flex items-center justify-between w-full max-w-5xl mx-auto">
            <div className="h-6 w-24 bg-zinc-700 rounded-md"></div> {/* Placeholder for logo */}
            <div className="flex space-x-4">
              <div className="h-6 w-16 bg-zinc-700 rounded-md"></div>
              <div className="h-6 w-16 bg-zinc-700 rounded-md"></div>
              <div className="h-6 w-20 bg-zinc-700 rounded-md"></div>
            </div>
          </div>
        </div>
      ) : (
        <Header
          ...
          className="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-zinc-800 text-zinc-50 shadow-lg"/>
      )}
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl pt-28 sm:pt-36 relative z-10">
        ...
        >
          <motion.h1
            ...
            className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-teal-500 mb-6 drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]"
          >
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
        >
          <div className="mb-20 p-10 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 border border-zinc-800 rounded-3xl shadow-2xl backdrop-blur-sm relative overflow-hidden">
            <div className="absolute inset-0 bg-blue-500 opacity-5 blur-3xl"></div>
            <motion.div variants={cardPop} className="relative z-10">
              <h2 className="text-4xl text-center text-zinc-50 font-bold mb-6 tracking-tight">Our Mission</h2>
              <motion.p variants={itemVariants} className="text-xl text-zinc-300 leading-relaxed text-center max-w-4xl mx-auto">
        ...
        >
          <motion.h2 variants={titleVariants} className="text-4xl font-bold text-center text-zinc-50 mb-12">The Problem We Solve</motion.h2>

          <div className="grid gap-10 md:grid-cols-2">
            {/* For Students Block - Less boxed */}
            <motion.div variants={itemVariants} className="p-8"> {/* Removed bg, border, shadow from here */}
              <h3 className="text-2xl text-red-400 font-semibold mb-6 flex items-center gap-3">
                <Target className="h-7 w-7 text-red-500" /> For Students
              </h3>
              <motion.ul variants={containerStagger} className="space-y-4 text-zinc-300 text-lg">
            ...
            <motion.div variants={itemVariants} className="p-8"> {/* Removed bg, border, shadow from here */}
              <h3 className="text-2xl text-red-400 font-semibold mb-6 flex items-center gap-3">
                <Target className="h-7 w-7 text-red-500" /> For Employers
              </h3>
              <motion.ul variants={containerStagger} className="space-y-4 text-zinc-300 text-lg">
                <motion.li variants={itemVariants} className="flex items-start">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
        >
          <motion.h2 variants={titleVariants} className="text-4xl font-bold text-center text-zinc-50 mb-12">Our Solution</motion.h2>
          ...
          <div className="grid gap-10 md:grid-cols-3">
            <Tilt className="w-full h-full" tiltMaxAngleX={5} tiltMaxAngleY={5} perspective={1000} transitionSpeed={1500}>
              <motion.div variants={cardPop} className="flex h-full">
                ...
                <div className="bg-zinc-900/40 border border-zinc-700 rounded-xl p-8 shadow-md backdrop-blur-sm flex flex-col justify-between w-full">
                  <div className="text-center pb-4">
                    <DollarSign className="h-12 w-12 text-emerald-400 mx-auto mb-4" />
                    <h3 className="text-2xl text-zinc-50 font-semibold">Affordable Access</h3>
                  </div>
                  <div className="text-center flex-grow flex items-center justify-center">
                    <motion.p variants={itemVariants} className="text-zinc-300 text-lg">
              ...
              <motion.div variants={cardPop} className="flex h-full">
                ...
                <div className="bg-zinc-900/40 border border-zinc-700 rounded-xl p-8 shadow-md backdrop-blur-sm flex flex-col justify-between w-full">
                  <div className="text-center pb-4">
                    ...
                    <h3 className="text-2xl text-zinc-50 font-semibold">Student-Focused</h3>
                  </div>
                  <div className="text-center flex-grow flex items-center justify-center">
                    <motion.p variants={itemVariants} className="text-zinc-300 text-lg">
              ...
              <motion.div variants={cardPop} className="flex h-full">
                ...
                <div className="bg-zinc-900/40 border border-zinc-700 rounded-xl p-8 shadow-md backdrop-blur-sm flex flex-col justify-between w-full">
                  <div className="text-center pb-4">
                    ...
                    <h3 className="text-2xl text-zinc-50 font-semibold">Quality Connections</h3>
                  </div>
                  <div className="text-center flex-grow flex items-center justify-center">
                    <motion.p variants={itemVariants} className="text-zinc-300 text-lg">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
        >
          <div className="mb-20 p-10 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 border border-zinc-800 rounded-3xl shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 bg-purple-500 opacity-5 blur-3xl"></div>
            <h2 className="text-4xl text-zinc-50 text-center font-bold mb-12 relative z-10">Our Values</h2>
            <div className="grid gap-10 md:grid-cols-2 relative z-10">
              {/* Lighter background, softer shadow */}
              <motion.div variants={itemVariants} className="p-6 rounded-xl bg-zinc-900/30 border border-zinc-800 shadow-sm group hover:border-blue-500 transition-colors duration-300">
                <h3 className="text-2xl font-semibold mb-4 text-blue-400 flex items-center gap-3">
                  <RocketIcon className="h-7 w-7 text-blue-500 group-hover:scale-110 transition-transform" /> Education First
                </h3>
              ...
              <motion.div variants={itemVariants} className="p-6 rounded-xl bg-zinc-900/30 border border-zinc-800 shadow-sm group hover:border-blue-500 transition-colors duration-300">
                <h3 className="text-2xl font-semibold mb-4 text-blue-400 flex items-center gap-3">
                  <ScaleIcon className="h-7 w-7 text-blue-500 group-hover:scale-110 transition-transform" /> Fair & Transparent
                </h3>
                <p className="text-zinc-300 text-lg">
              ...
              <motion.div variants={itemVariants} className="p-6 rounded-xl bg-zinc-900/30 border border-zinc-800 shadow-sm group hover:border-blue-500 transition-colors duration-300">
                <h3 className="text-2xl font-semibold mb-4 text-blue-400 flex items-center gap-3">
                  <ShieldCheckIcon className="h-7 w-7 text-blue-500 group-hover:scale-110 transition-transform" /> Legal Compliance
                </h3>
                <p className="text-zinc-300 text-lg">
              ...
              <motion.div variants={itemVariants} className="p-6 rounded-xl bg-zinc-900/30 border border-zinc-800 shadow-sm group hover:border-blue-500 transition-colors duration-300">
                <h3 className="text-2xl font-semibold mb-4 text-blue-400 flex items-center gap-3">
                  <HourglassIcon className="h-7 w-7 text-blue-500 group-hover:scale-110 transition-transform" /> Accessibility
                </h3>
                <p className="text-zinc-300 text-lg">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
        >
          <motion.h2 variants={titleVariants} className="text-4xl font-bold text-center text-zinc-50 mb-12">How We're Different</motion.h2>

          <div className="grid gap-10 md:grid-cols-2">
            <motion.div variants={itemVariants} className="flex h-full">
              {/* Thinner, softer border, slightly less rounded for a panel feel */}
              <div className="bg-gradient-to-br from-emerald-950/30 to-zinc-950/30 border border-emerald-800 rounded-xl p-8 shadow-lg flex flex-col w-full relative overflow-hidden group">
                <div className="absolute inset-0 bg-emerald-500 opacity-5 blur-3xl group-hover:opacity-10 transition-all duration-500"></div>
                <h3 className="font-semibold text-3xl text-emerald-400 mb-6 flex items-center gap-4 relative z-10">
                  <Check className="h-8 w-8 text-emerald-500" /> StudentJobs UK
                </h3>
                <motion.ul variants={containerStagger} className="space-y-4 text-emerald-300 text-lg flex-grow relative z-10">
                  <motion.li variants={itemVariants} className="flex items-start">
            ...
            <motion.div variants={itemVariants} className="flex h-full">
              {/* Thinner, softer border, slightly less rounded for a panel feel */}
              <div className="bg-gradient-to-br from-zinc-900/30 to-zinc-950/30 border border-zinc-800 rounded-xl p-8 shadow-lg flex flex-col w-full relative overflow-hidden group">
                <div className="absolute inset-0 bg-red-500 opacity-5 blur-3xl group-hover:opacity-10 transition-all duration-500"></div>
                <h3 className="font-semibold text-3xl text-zinc-200 mb-6 flex items-center gap-4 relative z-10">
                  <X className="h-8 w-8 text-red-500" /> Traditional Job Boards
                </h3>
                <motion.ul variants={containerStagger} className="space-y-4 text-zinc-300 text-lg flex-grow relative z-10">
                  <motion.li variants={itemVariants} className="flex items-start">
        ...
        >
          <div className="mb-20 p-10 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 border border-zinc-800 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-4xl text-zinc-50 text-center font-bold mb-12 relative z-10">Our Vision for the Future</h2>
            <motion.div variants={containerStagger} className="space-y-8 relative z-10">
              <motion.p variants={itemVariants} className="text-zinc-300 text-lg text-center max-w-4xl mx-auto">
              ...
              <motion.ul variants={containerStagger} className="list-disc list-inside pl-6 space-y-3 text-zinc-300 text-lg marker:text-emerald-400 max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
        >
          <motion.h2 variants={titleVariants} className="text-4xl font-bold text-center text-zinc-50 mb-12">Get in Touch</motion.h2>

          {/* New styling for a prominent contact block */}
          <div className="p-12 bg-gradient-to-tr from-purple-900/70 to-blue-900/70 border border-blue-700 rounded-3xl shadow-2xl backdrop-blur-md text-zinc-50 text-center">
            <motion.p variants={itemVariants} className="text-zinc-300 mb-8 text-xl max-w-2xl mx-auto">
      ...
      {/* --- Footer --- */}
<footer className="w-full bg-gray-900 text-gray-300 py-10 mt-20 border-t border-gray-800 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href={pricingHref} className="text-gray-400 hover:text-indigo-300 transition-colors duration-200">Pricing</Link>
                </li>
