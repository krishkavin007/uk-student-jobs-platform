              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-blue-200">
                  ...
                  <CardContent className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-green-600">✓ Refund Available:</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-red-600">✗ No Refund:</h4>
                      <ul className="text-sm space-y-1 mt-1">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-4">
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Refunded to original card</p>
                  <p className="text-xs text-gray-500 mt-2">5-10 business days</p>
                </div>
                <div className="text-center p-4 border rounded-lg">
                  <h4 className="font-semibold">PayPal</h4>
                  <p className="text-sm text-gray-600 mt-1">Refunded to PayPal account</p>
                  <p className="text-xs text-gray-500 mt-2">3-5 business days</p>
                </div>
                <div className="text-center p-4 border rounded-lg">
                  <h4 className="font-semibold">Alternative Methods</h4>
                  <p className="text-sm text-gray-600 mt-1">Bank transfer if original method unavailable</p>
                  <p className="text-xs text-gray-500 mt-2">3-5 business days</p>
                </div>
              </div>
            </section>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mt-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm">Email: refunds@studentjobs.uk</p>
                    <p className="text-sm">Response time: 2-3 business days</p>
                  </div>
                  <div>
                    <h4 className="font-semibold">General Support</h4>
                    <p className="text-sm">Email: support@studentjobs.uk</p>
                    <p className="text-sm">Through your account dashboard</p>
                  </div>
                </div>
              </div>
