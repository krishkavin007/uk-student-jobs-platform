...
const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case actionTypes.DISMISS_TOAST: {
      ...
      // ! This is technically not what we want. The idea is to remove the toast after it's been dismissed.
      if (toastId) {
        return {
          ...state,
          toasts: state.toasts.map((t) =>
...
type Toast = Pick<ToasterToast, "id" | "duration" | "promise"> &
  Partial<Pick<ToasterToast, "open" | "title" | "description" | "action" | "variant">>
