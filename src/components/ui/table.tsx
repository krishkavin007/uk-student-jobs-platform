...
import { cn } from "@/lib/utils" // Ensure you have '@/lib/utils' for cn (class-names utility)
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-gray-100/50 font-medium [&>tr]:last:text-base dark:bg-gray-800/50",
      className
    )}
    {...props}
  />
